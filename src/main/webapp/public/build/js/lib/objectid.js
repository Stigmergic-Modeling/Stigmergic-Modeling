define("js/lib/objectid", [], function(require, exports, module) {
    /*
     *
    ...
    var ObjectId = function() {
        ...
        function ObjId() {
            ...
            if (typeof arguments[0] == "object") {
                ...
                this.timestamp = Number("0x" + arguments[0].substr(0, 8)), this.machine = Number("0x" + arguments[0].substr(8, 6)), 
                this.pid = Number("0x" + arguments[0].substr(14, 4)), this.increment = Number("0x" + arguments[0].substr(18, 6));
